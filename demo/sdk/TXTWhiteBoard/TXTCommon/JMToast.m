...
@interface JMToast ()<TXTMBProgressHUDDelegate>

@property (nonatomic, strong)TXTMBProgressHUD *progressHUD;
...
- (TXTMBProgressHUD*)progressHUD {
    if (!_progressHUD) {
        _progressHUD = [[TXTMBProgressHUD alloc]initWithView:[[UIApplication sharedApplication] keyWindow]];
        _progressHUD.delegate = self;
        _progressHUD.animationType = TXTMBProgressHUDAnimationZoom;
        _progressHUD.mode = TXTMBProgressHUDModeCustomView;
