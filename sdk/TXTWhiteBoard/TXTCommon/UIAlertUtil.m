...
//            }
        ...
        //以modal的方式来弹出
//        [persentViewController.view addSubview:alert.view];
        [persentViewController presentViewController:alert animated:YES completion:NULL ];
        
    } else {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:title message:message delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:otherButtonTitles, nil];
...
//+(void)showAlertWithPersentViewController:(UIView *)persentView alertCallBack:(AlertCallBack)alertCallBack title:(NSString *)title message:(NSString *)message cancelButtonTitle:(NSString *)cancelButtonTitle otherButtonTitles:(NSString *)otherButtonTitles, ...;
