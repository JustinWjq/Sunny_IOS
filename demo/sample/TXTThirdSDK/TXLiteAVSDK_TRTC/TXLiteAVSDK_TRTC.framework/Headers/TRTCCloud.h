 ...
 *   - 低清大画面：TRTCVideoStreamTypeSmall
...
*/
- (void)snapshotVideo:(NSString *)userId type:(TRTCVideoStreamType)type completionBlock:(void (^)(TXImage *image))completionBlock;
 ...
 * 3.14 设置本地图像的渲染模式
 *
 * @deprecated v8.0 版本弃用，请使用 setLocalViewRenderParams:streamType:params 接口
 * @param mode 填充（画面可能会被拉伸裁剪）或适应（画面可能会有黑边），默认值：TRTCVideoFillMode_Fill
 */
- (void)setLocalViewFillMode:(TRTCVideoFillMode)mode __attribute__((deprecated("use setLocalViewRenderParams:streamType:params instead")));
 ...
 * @param rotation 支持90、180以及270旋转角度，默认值：TRTCVideoRotation_0
 */
- (void)setLocalViewRotation:(TRTCVideoRotation)rotation __attribute__((deprecated("use setLocalViewRenderParams:streamType:params instead")));
 ...
 */
- (void)setLocalViewMirror:(TRTCLocalVideoMirrorType)mirror __attribute__((deprecated("use setLocalViewRenderParams:streamType:params instead")));
#elif TARGET_OS_MAC
 ...
 */
- (void)setLocalViewMirror:(BOOL)mirror __attribute__((deprecated("use setLocalViewRenderParams:streamType:params instead")));
#endif
