...
static NSString * const FORMAT_THIS_WEEK = @"eee HH:mm";
...
+ (NSString *)getFriendlyDateString:(NSTimeInterval)timeInterval
  ...
  if (theDiff < 60) {
    ...
    output = [NSString stringWithFormat:@"%d%@", minute, @"分钟前"];

  } else {
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
      if ([[NSString getCurrentLocaleLanguageCode] isEqualToString:@"zh"]) {
